...
from torch.nn.utils.rnn import pad_sequence
# import AdMSoftmaxLoss #https://github.com/Leethony/Additive-Margin-Softmax-Loss-Pytorch
# import Conformer
...
class Classifier(nn.Module):
	def __init__(self, d_model=512, n_spks=600, dropout=0.1):
		...
		# 	d_model=d_model, dim_feedforward=300, nhead=1
		# )
	...
	def forward(self, mels):
		...
		# mean pooling ---------可以換成self attention
		#參考https://gist.github.com/pohanchi/c77f6dbfbcbc21c5215acde4f62e4362的方式
		att_pooling = torch.sum(out * (F.softmax(self.input(out).squeeze(-1)).unsqueeze(-1)),dim=1)
		stats = att_pooling
